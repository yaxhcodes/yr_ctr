...
export default function TabsContainer() {
  ...
  return (
    <div
      className="flex flex-col items-center min-h-screen bg-cover bg-center bg-no-repeat p-2 pt-4"
      style={{ backgroundImage: `url('/vagabond.gif')` }}
    >
      <Tabs
        value={activeTab}
      ...
      <div
        className={`w-full max-w-2xl mt-2 ${activeTab !== 'focus' ? 'hidden' : ''}`}
      >
        <MusicPlayer />
      </div>
    </div>
